<div class="email-container">
        ...
        <div class="content">
            ...
            <p>In the meantime, you might find answers to common questions in our <a href="#" style="color: #0066ff;">FAQ section</a>.</p>

            <div style="text-align: center; margin: 30px 0;">
                <a href="#" class="button">Visit Our Website</a>
            </div>

            <p>If you have any urgent questions, please don't hesitate to contact us at <a href="mailto:support@example.com" style="color: #0066ff;">support@example.com</a>.</p>
            ...
            <p style="font-size: 14px; color: #6c757d;">
                This is an automated email, please do not reply directly to this message. If you did not request this email, you can safely ignore it.
            </p>
        </div>
